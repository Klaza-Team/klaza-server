            ...
            <div v-if="type == 'server'" class="absolute-top indicator">
                <div>
                    ...
                    <q-tooltip class="tooltip">
                        <span v-if="hasDiscod"> Conectado com o Discord </span>
                        <span v-else> Não conectado com o Discord </span>
                    </q-tooltip>
                ...
                <div>
                    ...
                    <q-tooltip class="tooltip">
                        <span v-if="hasTelegram"> Conectado com o Telegram </span>
                        <span v-else> Não conectado com o Telegram </span>
                    </q-tooltip>
