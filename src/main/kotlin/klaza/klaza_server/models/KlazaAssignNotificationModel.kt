...
class KlazaAssignNotificationModel() {
    ...
    var assign: AssignModel? = null

    constructor(assign: AssignModel, eventName: String) : this() {
        this.assign = assign
        this.eventname = eventName
    }

    constructor(id: Long, assign: AssignModel, eventName: String) : this() {
        this.id = id
        this.assign = assign
        this.eventname = eventName
    }
