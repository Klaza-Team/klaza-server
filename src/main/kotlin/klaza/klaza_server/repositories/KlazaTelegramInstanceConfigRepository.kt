// Plugin Klaza para Moodle - Server - KlazaTelegramInstanceConfigRepository.kt
...
interface KlazaTelegramInstanceConfigRepository : JpaRepository<KlazaTelegramInstanceConfigModel, Long> {
    ...
    fun findByTelegramInstance_Id(telegramInstanceId: Long): KlazaTelegramInstanceConfigModel?
